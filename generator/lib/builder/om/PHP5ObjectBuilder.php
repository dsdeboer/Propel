<?php
/**
 * Created by Duncan de Boer <duncan.de.boer@axtion.nl>
 * Date: 8/9/2017
 * Time: 11:49 AM
 */
    ...
    protected function addArrayMutator(&$script, Column $col)
    {
        ...
        if (\$this->$cloUnserialized !== \$v) {
            ...
            if (!is_array(\$v) && strpos(\$v, '| ') === 0) {
                \$$cloUnserialized = substr(\$v, 2, -2);
                \$v = \$$cloUnserialized ? explode(' | ', \$$cloUnserialized) : array();
            }
            
            \$this->$clo = json_encode((array) \$v);
...
{";
    ...
    protected function addClassBody(&$script)
    {
        ...
        $this->declareClasses('Propel', 'PropelException', 'PDO', 'PropelPDO', 'PropelQuery', 'Criteria', 'Persistent', 'BasePeer', 'PropelCollection', 'PropelObjectCollection',
            'Exception');
...
";
    ...
    protected function addArrayAccessorBody(&$script, Column $col)
    {
        ...
        if (!\$this->$cloUnserialized && null !== \$this->$clo) {
            \$this->$cloUnserialized = json_decode(\$this->$clo, true);
        }
